...
# sceasy::convertFormat(file.path(PATH, "data/sc/cellxgene/all_cellxgene.h5ad"), from="anndata", to="seurat",
#                       outFile=file.path(PATH, "data/sc/cellxgene/all.rds"))

# Loading Data
all_seurat <- readRDS(file.path(PATH, "data/sc/cellxgene/all.rds"))
