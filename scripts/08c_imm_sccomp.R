...
df_1 <- imm_metadata %>% dplyr::select(sample_id, cluster_annot_sub, grade_bin, batch, subtype_new, age)
df_2 <- imm_metadata %>% dplyr::select(sample_id, cluster_annot_sub, grade_bin, batch, pam50, age)
df_3 <- imm_metadata %>% dplyr::select(sample_id, cluster_annot_sub, ob_bin, batch, subtype_new, age)
df_4 <- imm_metadata %>% dplyr::select(sample_id, cluster_annot_sub, ob_bin, batch, pam50, age)
df_5 <- imm_metadata %>% dplyr::select(sample_id, cluster_annot_sub, ir_bin, batch, subtype_new, age)
df_6 <- imm_metadata %>% dplyr::select(sample_id, cluster_annot_sub, ir_bin, batch, pam50, age)
df_7 <- imm_metadata %>% dplyr::select(sample_id, cluster_annot_sub, batch, pam50, age)
