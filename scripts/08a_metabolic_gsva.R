...
# Pseudobulk Data
combined_data_avg <- readRDS(file.path(PATH, "data/pseudobulk/combined_data_pb.rds"))
...
imm_sigs <- readRDS(file.path(PATH, "data/signatures/immune/boroni_vanderleun_chu_hbca_sigs.rds"))
imm_gsva <- gsva(combined_data_avg_sce,
                   imm_sigs,
                   mx.diff=TRUE,
                   verbose=FALSE) 
saveRDS(imm_gsva, file.path(PATH, "data/pseudobulk/combined_data_gsva_imm.rds"))